...
<html>
  ...
  <br><br><br>
        ...
        <div class="container">
            ...
            <?php 
            $sql = "SELECT m . * , s . * FROM members m LEFT JOIN services s ON m . username = s . username WHERE s . lawf = 1";            
            $result=display($sql);
            //echo "TEST";
            //echo $result;
        ...
        <div class="container">
            ...
            <?php 
            $sql = "SELECT m . * , s . * FROM members m LEFT JOIN services s ON m . username = s . username WHERE s . consult = 1";            
            $result=display($sql);
            //echo "TEST";
            //echo $result;
            if($result->num_rows > 0)
