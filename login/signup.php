...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-sm-4">
      <form class="form-signup" id="usersignup" name="usersignup" method="post" action="createuser1.php"><br><br>
      <a href="main_login.php" class="btn btn-lg btn-primary btn-block" style="background-color: #006064; width: 70px;">Sign In</a>
        <h2 class="form-signup-heading">Register For Service Providers</h2>
