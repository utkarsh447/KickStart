  ...
  <body background="../login/images/wonder_woman.jpg">
    ...
    <div class="col-sm-4">
      <!-- <form class="form-signin" name="form1" method="post" action="../index1.php"> --><br><br><br><br> 
        <h2 class="form-signin-heading" ><center>Log In for Users</center></h2><br>
        ...
        <!-- <h3>Sign in<br><h3> -->
        <br>
        <a href="../index1.php"><div class="alert alert-success" role="alert" style="text-decoration : none" align="center" style="background-color: BLACK">
