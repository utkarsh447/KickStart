...
<html>
  ...
  <br><br><br>
        ...
        <div class="container">
            ...
            <?php 
            $sql = "SELECT m . * , s . * FROM members m LEFT JOIN services s ON m . username = s . username WHERE s . dataA = 1";            
            $result=display($sql);
            //echo "TEST";
            //echo $result;
        ...
        ?>
         ...
         <div class="container">
            ...
            <?php 
            $sql = "SELECT m . * , s . * FROM members m LEFT JOIN services s ON m . username = s . username WHERE s . digiM = 1";            
            $result=display($sql);
            //echo "TEST";
            //echo $result;
            if($result->num_rows > 0)
        ...
        <div class="container">
            ...
            <?php 
            $sql = "SELECT m . * , s . * FROM members m LEFT JOIN services s ON m . username = s . username WHERE s . humanr = 1";            
            $result=display($sql);
            //echo "TEST";
            //echo $result;
            if($result->num_rows > 0)
        ...
        <div class="container">
            ...
            <?php 
            $sql = "SELECT m . * , s . * FROM members m LEFT JOIN services s ON m . username = s . username WHERE s . bussD = 1";            
            $result=display($sql);
            //echo "TEST";
            //echo $result;
            if($result->num_rows > 0)
